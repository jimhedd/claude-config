...
- Keep this command short and practical.
- Keep the strongest piece: parallel review agents.
- Do not prescribe a dedicated verification framework or fixed verification commands.
